      ...
      <div className="rounded-2xl border border-edge/80 bg-raise/40 p-3.5 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="flex h-5 w-5 items-center justify-center rounded-lg bg-accent/20 text-accent">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-1">
                  ...
                  {isSelected && (
                    <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-accent text-slate-950">
                      <svg className="h-2.5 w-2.5 stroke-[3]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-edge/60 pt-2.5">
          <div className="flex items-center justify-between">
            ...
            >
              <svg className={`h-3 w-3 transition-transform ${fontOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
