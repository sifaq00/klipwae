...
5. ✅ **DONE** — Whisper model caching (singleton)
6. ⏳ **OPEN** — Reframe multi-pass consolidation (future consideration)
7. ✅ **DONE** — DB indexes di `schema.sql`
8. ✅ **DONE** — Pindah `_ensure_columns()` ke `init_db()`
9. ✅ **DONE** — Tracker 32-frame mini-batching
10. ✅ **DONE** — Ingest metadata deduplication
11. ✅ **DONE** — Throttle SSE log stream (buffer + flush 100ms)
12. ✅ **DONE** — `React.memo` pada card components
13. ✅ **DONE** — Fix reburn polling cleanup

### Fase C — UX & Reliability (P2) ⏱️ ~1 jam
> Polish yang bikin app lebih robust

14. ✅ **DONE** — Error Boundary
15. ✅ **DONE** — Mobile PlayerModal fix
16. ✅ **DONE** — Fix `stageLabel` mapping
17. ✅ **DONE** — Deduplikasi code (STATUS_TO_STAGE, clipboard)
18. ✅ **DONE** — Fix transcribe spinner leak (try/finally)
19. ✅ **DONE** — Reburn captions non-blocking
20. ✅ **DONE** — ARIA accessibility labels & switch roles
21. ✅ **DONE** — Inline confirm dialog

### Fase D — Cleanup & Architecture (P3) ⏱️ ~30 menit
> Housekeeping, dead code removal

22. ✅ **DONE** — Dead code & unused animations removal
23. ✅ **DONE** — Lazy-load `StyleEditor` via `React.lazy`
24. ✅ **DONE** — API pagination & helper deduplication
